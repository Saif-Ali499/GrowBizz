...
export const setupMessageListener = createAsyncThunk(
  ...
  async (chatId, { dispatch, rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error.message || 'Failed to setup message listener');
    }
  }
);
    ...
    try {
      ...
      try {
        ...
        if (recipientDoc.exists()) {
          ...
          recipientName = recipientData.name || recipientData.displayName || recipientData.email || 'Unknown User';
      ...
      if (initialMessage) {
        ...
        try {
          ...
          if (senderDoc.exists()) {
            ...
            senderName = senderData.name || senderData.displayName || senderData.email || 'Unknown User';
